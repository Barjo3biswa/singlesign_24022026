        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                ...
                <div>
				   ...
				   <select name="lang_choice" id="lang_choice_polylang-4" class="select-languege"><option value="en">English</option><option value="hi">Hindi</option><option value="asm" selected="selected">Assamese</option><option value="bn">Bengali</option>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="ilrms_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
						...
						<li class="nav-item">
                            <a class="nav-link" href="iindex.html"><center><img src='assets/img/home.png' width='40%'></center></a>
                        </li>
                        <li class="nav-item">
...
<?php //include('flash_message.php'); ?>
    ...
    <select name="district" class="form-control" id='district1'>
            ...
            <?php if (IS_PRODUCTION == 0) { ?>
                <option value="<?=UAT_DB_NAME?>" <?php if(isset($_GET['district']) && $_GET['district']=='<?=UAT_DB_NAME?>') {echo 'selected'; } ?> > TEST_DB (<?=UAT_DB_NAME?>) </option>
	    <?php }else{ ?>
            <option value="bajali" <?php if(isset($_GET['district']) && $_GET['district']=='bajali') {echo 'selected'; } ?> > Bajali </option>
            
            <option value="barpeta" <?php if(isset($_GET['district']) && $_GET['district']=='barpeta') {echo 'selected'; } ?> > Barpeta </option>
            <option value="biswanath" <?php if(isset($_GET['district']) && $_GET['district']=='biswanath') {echo 'selected'; } ?> > Biswanath </option>
            <option value="bongaigaon" <?php if(isset($_GET['district']) && $_GET['district']=='bongaigaon') {echo 'selected'; } ?> > Bongaigaon </option>
            <option value="charaideo" <?php if(isset($_GET['district']) && $_GET['district']=='charaideo') {echo 'selected'; } ?> > Charaideo </option>
            <option value="cachar" <?php if(isset($_GET['district']) && $_GET['district']=='cachar') {echo 'selected'; } ?> > Cachar </option>
            
            <option value="darrang" <?php if(isset($_GET['district']) && $_GET['district']=='darrang') {echo 'selected'; } ?> > Darrang </option>
             <option value="dhemaji" <?php if(isset($_GET['district']) && $_GET['district']=='dhemaji') {echo 'selected'; } ?> > Dhemaji </option>
            <option value="dhubri" <?php if(isset($_GET['district']) && $_GET['district']=='dhubri') {echo 'selected'; } ?> > Dhubri </option>
            <option value="dibrugarh" <?php if(isset($_GET['district']) && $_GET['district']=='dibrugarh') {echo 'selected'; } ?> > Dibrugarh </option>
            <option value="goalpara" <?php if(isset($_GET['district']) && $_GET['district']=='goalpara') {echo 'selected'; } ?> > Goalpara </option>
            <option value="golaghat" <?php if(isset($_GET['district']) && $_GET['district']=='golaghat') {echo 'selected'; } ?> >Golaghat </option>
            <option value="hailakandi" <?php if(isset($_GET['district']) && $_GET['district']=='hailakandi') {echo 'selected'; } ?> > Hailakandi </option>
            <option value="hojai" <?php if(isset($_GET['district']) && $_GET['district']=='hojai') {echo 'selected'; } ?> > Hojai </option>
            <option value="jorhat" <?php if(isset($_GET['district']) && $_GET['district']=='jorhat') {echo 'selected'; } ?> > Jorhat </option>
            <option value="kamrup" <?php if(isset($_GET['district']) && $_GET['district']=='kamrup') {echo 'selected'; } ?> > Kamrup </option>
            <option value="kamrupM" <?php if(isset($_GET['district']) && $_GET['district']=='kamrupM') {echo 'selected'; } ?> > KamrupMetro </option>
            <option value="karimganj"  <?php if(isset($_GET['district']) && $_GET['district']=='karimganj') {echo 'selected'; } ?> > Karimganj </option>
            <option value="lakhimpur" <?php if(isset($_GET['district']) && $_GET['district']=='lakhimpur') {echo 'selected'; } ?> > Lakhimpur </option>
            <option value="majuli" <?php if(isset($_GET['district']) && $_GET['district']=='majuli') {echo 'selected'; } ?> > Majuli </option>
            <option value="morigaon" <?php if(isset($_GET['district']) && $_GET['district']=='morigaon') {echo 'selected'; } ?> > Morigaon </option>
            <option value="nagaon" <?php if(isset($_GET['district']) && $_GET['district']=='nagaon') {echo 'selected'; } ?> > Nagaon </option>
            <option value="nalbari" <?php if(isset($_GET['district']) && $_GET['district']=='nalbari') {echo 'selected'; } ?> > Nalbari </option>
            <option value="sibsagar" <?php if(isset($_GET['district']) && $_GET['district']=='sibsagar') {echo 'selected'; } ?> > Sibsagar </option>
            <option value="sonitpur" <?php if(isset($_GET['district']) && $_GET['district']=='sonitpur') {echo 'selected'; } ?> > Sonitpur </option>
            <option value="ssalmara" <?php if(isset($_GET['district']) && $_GET['district']=='ssalmara') {echo 'selected'; } ?> > SouthSalmara </option>
            <option value="tinsukia" <?php if(isset($_GET['district']) && $_GET['district']=='tinsukia') {echo 'selected'; } ?> > Tinsukia </option>
<?php } ?>							
    </select>
...
<!------Modal End----------> 
<?php if(ENABLE_LOGIN_OTP == 1) { include "login_sms_otp.php"; }?>
<script>
    ...
    function check_credentials(){        
        ...
        $.ajax({
            ...
            data        : {"uname" : uname,"dist_code": district}, // our data object
